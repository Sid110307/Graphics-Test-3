...
import android.opengl.GLES10.GL_NORMAL_ARRAY
import android.opengl.GLES10.GL_TEXTURE_COORD_ARRAY
import android.opengl.GLES20.GL_FLOAT
import android.opengl.GLES20.GL_TRIANGLES
import android.opengl.GLES20.GL_UNSIGNED_SHORT
import android.opengl.GLES32.GL_VERTEX_ARRAY
...
class Sphere(radius: Float, slices: Int, stacks: Int) {
	...
	fun draw(gl: GL10) {
		...
		gl.glTexCoordPointer(2, GL_FLOAT, 0, texCoordinates)
...
class Cone(baseRadius: Float, height: Float, slices: Int, stacks: Int) {
	private val vertices: FloatBuffer
	private val normals: FloatBuffer
	private val texCoordinates: FloatBuffer
	private val indices: ShortBuffer
...
class Cylinder(baseRadius: Float, topRadius: Float, height: Float, slices: Int, stacks: Int) {
	private val vertices: FloatBuffer
	private val normals: FloatBuffer
	private val texCoordinates: FloatBuffer
	private val indices: ShortBuffer
